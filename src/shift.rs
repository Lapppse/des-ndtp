...
impl ShiftSchemes {
    pub fn as_slice<'a>(&self) -> &'a [usize] {
        match self {
            ...
            .as_slice(),
            Self::IP1 => [
                39, 7, 47, 15, 55, 23, 63, 31, 38, 6, 46, 14, 54, 22, 62, 30, 37, 5, 45, 13, 53,
            ...
            Self::S8 => [
                ...
                12, 5, 6, 11, 0, 14, 9, 2, 7, 11, 4, 1, 9, 12, 14, 2, 0, 6, 10, 13, 15, 3, 5, 8, 2,
    ...
    pub fn get_s_schemes<'a>() -> &'a [ShiftSchemes] {
        [
            Self::S1,
            Self::S2,
            Self::S3,
